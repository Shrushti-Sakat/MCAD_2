...
export function EnquiryForm({ regardingText, enquiryType = "enquiry", itemName = "" }: { regardingText: string; enquiryType?: string; itemName?: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // itemName = clean name (e.g. "Digital Twin Foundation...")
      // regardingText = display text with prefix (e.g. "Course: Digital Twin Foundation...")
      await fetch("/api/send-enrollment-email", {
        ...
        body: JSON.stringify({
          ...
          organization: "",
          message,
          trackName: itemName || regardingText || "General Enquiry",
          type: enquiryType,
        }),
      });
